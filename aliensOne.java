 ...
 * Numair Jaan
 * aliensOne
 * Creates alien one object used in the game
 */
...
public class aliensOne extends ObjectReference{
	...
	*/
	public aliensOne(int x, int y) {
		...
		image = kit.getImage("gameimg/balien1.png");
		image = image.getScaledInstance(width, height, Image.SCALE_SMOOTH);
	}
	/* Purpose of method: Move alien1 to the left or right based on boolean - moveLeft
	 * Accepts: 
	 * Returns: this.alien1 new x coordinate
	 */
	public void move() {
	...
	/* Purpose of method: Move alien1 to the down based on boolean - moveDown
	 * Accepts: 
	 * Returns: this.alien1 new y coordinate
	 */
	 ...
	 * Accepts: 
	 * Returns: this.alien1 moveLeft either true if reaches right border and false if it reaches left border
	 */
	public void update() {
